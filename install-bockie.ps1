# install-bockie.ps1
# Bockie v2.5.0 Windows Installer (build from source)
# Run: powershell -ExecutionPolicy Bypass -File install-bockie.ps1

$ErrorActionPreference = "Continue"

Write-Host ""
Write-Host "  Bockie v2.5.0 - Windows Installer (from source)" -ForegroundColor Cyan
Write-Host "  Created by xobe" -ForegroundColor Gray
Write-Host ""
Write-Host ("=" * 50)

$vscodeExtDir = "$env:USERPROFILE\.vscode\extensions\bockie-2.5.0"
